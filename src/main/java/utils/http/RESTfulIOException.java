 ...
 * unchecked 예외.
 * <p>
 * 이름에 {@code IOException}이 들어가지만 {@link RESTfulException}을 통해 {@link RuntimeException}을
 * 상속하여 호출부에 checked 예외를 강제하지 않는다(레포의 {@code Runtime*Exception} 래핑 컨벤션).
 *
 * @author Kang-Woo Lee (ETRI)
 */
public class RESTfulIOException extends RESTfulException {
